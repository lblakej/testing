...
def check_eligibility(years_booksales, years_book_manager):
    if years_booksales >= MIN_YEARS_BOOKSALES and years_book_manager >= MIN_YEARS_BOOK_MANAGER:
        return 'Congratulations! You are eligible and qualified to be the new Bookseller Manager!'
    else:
        return f'''
...
if __name__ == "__main__":
    ...
    result = check_eligibility(years_booksales, years_book_manager)
    print(result)
